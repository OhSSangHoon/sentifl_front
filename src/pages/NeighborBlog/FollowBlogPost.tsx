...
import * as S from "./Styles/FollowBlogPost.style";
import { PostData, CommentData, pulse } from "./Styles/FollowBlogPost.style";
import {
  FaPaperPlane,
  FaPlay,
  FaComment,
        ...
        {showCommentInput && (
          <S.FixedBottomBar>
            <S.InputField
              ...
              value={isEditing ? commentContent : newCommentContent}
              onChange={
                isEditing
